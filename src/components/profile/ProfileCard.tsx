...
const ProfileCard = ({ 
  ...
  const levelNames = ['Newbie', 'Bronze', 'Silver', 'Gold', 'Platinum', 'Diamond'];
    ...
    >
      ...
      <div className="mb-6">
        ...
        <div className="flex justify-between mt-1 text-xs text-gray-500 dark:text-gray-400">
          <span>{userProfile.xp} Points</span>
          <span>Target: {userProfile.xpToNextLevel} Points</span>
        </div>
      </div>
